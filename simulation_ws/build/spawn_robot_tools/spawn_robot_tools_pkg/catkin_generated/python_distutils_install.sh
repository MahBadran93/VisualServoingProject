...
echo_and_run cd "/home/user/simulation_ws/src/spawn_robot_tools/spawn_robot_tools_pkg"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/user/simulation_ws/src/spawn_robot_tools/spawn_robot_tools_pkg/setup.py" \
    build --build-base "/home/user/simulation_ws/build/spawn_robot_tools/spawn_robot_tools_pkg" \
    install \
    $DESTDIR_ARG \
